@echo off
REM Compila y ejecuta test_auxiliary_functions_comprehensive.cpp con el compilador especificado (msvc, g++, clang++)
REM Uso: compile_auxiliary_functions_comprehensive.bat [msvc|g++|clang++]
setlocal
set SRC=test_auxiliary_functions_comprehensive.cpp
set EXE=test_auxiliary_functions_comprehensive.exe
set OUT=tests\%EXE%
set COMPILER=%1
